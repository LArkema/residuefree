...
## Small edits were made to the main residuefree.sh file after this one was used to test file operations
## without encryption (the ecryptfs file system). However, we have no reason to believe that these small 
## edits had any substantive impact on run times.
